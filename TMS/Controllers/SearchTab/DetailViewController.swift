...
class DetailViewController: UIViewController {
    ...
    lazy var adultView = CustomPassangersView(title: SearchViewController.adult, infoIcon: false, count: adultCounter)
    lazy var bikeView = CustomPassangersView(title: SearchViewController.bike, infoIcon: true, count: bikeCounter)
    lazy var childView = CustomPassangersView(title: SearchViewController.child, infoIcon: false, count: childCounter)
    ...
    private func configureSubviews() {
        ...
        titleLabel.text = "Пассажиры и багаж"
